...
__credits__     = ["Mike Schmit; Hansel Yang; Lakshmi Kumar; Seyedreza Najafi"]
__license__     = "MIT"
__version__     = "1.0"
__maintainer__  = "Kiriti Nagesh Gowda"
__email__       = "Kiriti.NageshGowda@amd.com"
__status__      = "Shipping"
__script_name__ = "MIVisionX Machine Learning Validation Tool"
...
raliList_mode4_16 = ['original', 'original', 'original', 'original',
					...
					'original', 'original', 'original', 'original',
					'original', 'original', 'original', 'original']
raliList_mode5_16 = ['nop', 'nop', 'nop', 'nop',
					'nop', 'nop', 'nop', 'nop',
					'nop', 'nop', 'nop', 'nop',
					'nop', 'nop', 'nop', 'nop']
